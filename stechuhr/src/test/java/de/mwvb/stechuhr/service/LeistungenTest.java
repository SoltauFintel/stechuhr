...
public class LeistungenTest {
	...
	public void testUmlaute() {
		...
		Assert.assertEquals("Check 2 failed", leistung, leistungen.getLeistungForTicket("Spaß"));
		
		Leistungen geladen = Leistungen.open("TEST");
		Assert.assertEquals("Check 3 failed", leistung, geladen.getFirst());
		Assert.assertEquals("Check 4 failed", leistung, geladen.getLeistungForTicket("Spaß"));
	}
